...
[**track_page_view**](PageApi.md#track_page_view) | **PATCH** /v1/pages/{id}/track/view/ | Track a view of a landing page.
...
# **track_page_view**
> TrackPageView track_page_view(id, view)
...
view = mailmojo_sdk.TrackPageView() # TrackPageView | 

try:
    # Track a view of a landing page.
    api_response = api_instance.track_page_view(id, view)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PageApi->track_page_view: %s\n" % e)
```
 ...
 **view** | [**TrackPageView**](TrackPageView.md)|  | 

### Return type

[**TrackPageView**](TrackPageView.md)
