...
class ListsApi(object):
    ...
    def get_list_by_id(self, list_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_list_by_id(list_id, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.get_list_by_id_with_http_info(list_id, **kwargs)
        else:
            (data) = self.get_list_by_id_with_http_info(list_id, **kwargs)
            return data

    def get_list_by_id_with_http_info(self, list_id, **kwargs):
        """
        Retrieve an email list.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_list_by_id_with_http_info(list_id, callback=callback_function)
        ...
        if ('list_id' not in params) or (params['list_id'] is None):
            raise ValueError("Missing the required parameter `list_id` when calling `get_list_by_id`")
    ...
    def get_lists_with_http_info(self, **kwargs):
        ...
        resource_path = '/lists/'.replace('{format}', 'json')
        path_params = {}
    ...
    def update_list(self, list_id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_list(list_id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_list_with_http_info(list_id, **kwargs)
        else:
            (data) = self.update_list_with_http_info(list_id, **kwargs)
            return data

    def update_list_with_http_info(self, list_id, **kwargs):
        """
        Update an email list partially.
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_list_with_http_info(list_id, callback=callback_function)
