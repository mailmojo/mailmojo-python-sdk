...
class NewsletterApi(object):
    ...
    def send_newsletter(self, **kwargs):  # noqa: E501
        """Send a newsletter.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.send_newsletter(async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.send_newsletter_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.send_newsletter_with_http_info(**kwargs)  # noqa: E501
            return data

    def send_newsletter_with_http_info(self, **kwargs):  # noqa: E501
        """Send a newsletter.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.send_newsletter_with_http_info(async=True)
        >>> result = thread.get()
    ...
    def test_newsletter(self, **kwargs):  # noqa: E501
        """Send a test newsletter.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.test_newsletter(async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.test_newsletter_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.test_newsletter_with_http_info(**kwargs)  # noqa: E501
            return data

    def test_newsletter_with_http_info(self, **kwargs):  # noqa: E501
        """Send a test newsletter.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.test_newsletter_with_http_info(async=True)
        >>> result = thread.get()
