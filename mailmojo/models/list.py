...
class List(object):
    ...
    """
    def __init__(self, description=None, facebook=None, from_email=None, from_name=None, instagram=None, linkedin=None, name=None, subscribe_redirect_url=None, twitter=None, unsubscribe_cascades=True, unsubscribe_redirect_url=None, website=None):
        """
